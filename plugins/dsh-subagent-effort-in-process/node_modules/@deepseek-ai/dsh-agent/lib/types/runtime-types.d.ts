...
export interface AgentOptions {
    ...
    maxTokens?: number;
    /**
     * Optional per-agent reasoning effort. The agent loop itself does not read
     * this field; an extension (for example a subagent provider) applies it
     * through the `agent/request` waterfall, where the routed adapter validates
     * it against the model's capabilities and the effective value is logged in
     * the request header.
     */
